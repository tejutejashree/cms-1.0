...
const Loading = () => {
  return <div className="spinner-border text-success" role={'status'}> <span className="visually-hidden">Loading...</span></div>
}
                  ...
                  <div className="card-footer">
                      {
                        img ? (
                          ...
                          <div className="form-group">
                            <input type="file" name={"img"} id ={"img"} className="form-control" required onChange={handleUpload} />
                          </div>
                        )
                      }
                  </div>
